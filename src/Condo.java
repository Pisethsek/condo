        ...
        do{
            ...
            if(floor>0){
                ...
                if(room>0){
                    ...
                    System.out.println("Total condo is : "+(floor*room));
                }else
                    isCondition = false;
            }else {
                isCondition = false;
                        ...
                        if(sellFloor>0 && sellFloor <= floor){
                            ...
                            if(sellRoom>0 && sellRoom <=room){
                                ...
                                if(condo[sellFloor-1][sellRoom-1]==null){
                                    ...
                                    System.out.println("Press 1 to sell and 0 to cancel");
                                    int pr = input.nextInt();
//                                    condoOwner = input.nextLine();
                                    if(pr == 1){
                                        condo[sellFloor -1][sellRoom-1] = null ;
                                    }else if (pr == 0){
                                        System.out.println("You don't buy it");
                                    }
                                    else {
